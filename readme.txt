...
= 2.0.0 =
* IMPORTANT: This release includes major changes to the Admin interface. Front-end should be a seamless update,
* BUT YOU SHOULD ALWAYS BACK UP FILES AND DATA BEFORE UPGRADING. 
* Please see the updated documentation: http://www.lilaeamedia.com/plugins/intelliwidget
...
* Added autoloading of admin scripts
