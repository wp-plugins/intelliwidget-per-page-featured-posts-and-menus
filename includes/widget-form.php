    ...
    <div id="<?php echo $this->get_field_id('customtext'); ?>-inside" style="display:none;padding:8px" class="closed">
        <p>
            <label for="<?php echo $this->get_field_id('text_position'); ?>">
                <?php _e( 'Display', 'intelliwidget'); ?>: </label>
...
<div class="postbox">
    <div class="iw-collapsible" id="<?php echo $this->get_field_id('advancedsettings'); ?>" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
        <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
        <h4 style="margin:0;padding:8px">
    ...
    <div id="<?php echo $this->get_field_id('advancedsettings'); ?>-inside" style="display:none;padding:8px" class="closed">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('sortby'); ?>">
                <?php _e( 'Sort by', 'intelliwidget'); ?>: </label>
        ...
        <p>
            <label for="<?php print $this->get_field_id('imagealign'); ?>">
                <?php _e('Image Align', 'intelliwidget'); ?>: </label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('post_types_' . $type); ?>">
