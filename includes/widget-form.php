...
<p> <?php echo $intelliwidget->docsLink; ?>
  <label>
    ...
    <?php _e('Placeholder (hide unless post-specific)', 'intelliwidget'); ?>
  </label>
</p>
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('generalsettings'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
  ...
  <div id="<?php echo $this->get_field_id('generalsettings'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <p>
      <label for="<?php echo $this->get_field_id('title'); ?>"> <?php echo __('Widget', 'intelliwidget') . ' ' . __('Title', 'intelliwidget') . ' ' . __('(Optional)', 'intelliwidget'); ?>: </label>
      <br/>
    ...
    <p>
      ...
      <select id="<?php echo $this->get_field_id('nav_menu'); ?>" name="<?php echo $this->get_field_name('nav_menu'); ?>">
        ...
        <?php _e('None (Use List Settings)', 'intelliwidget'); ?>
        </option>
...
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('customtext'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
    <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
    <h4 style="margin:0;padding:8px">
      <?php _e('Custom Text/HTML', 'intelliwidget'); ?>
    </h4>
  </div>
  <div id="<?php echo $this->get_field_id('customtext'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <p>
...
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('listsettings'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
    <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
    <h4 style="margin:0;padding:8px">
      <?php _e('List Settings', 'intelliwidget'); ?>
    </h4>
  </div>
  <div id="<?php echo $this->get_field_id('listsettings'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <p>
      <label>
        <?php _e('Post Types', 'intelliwidget'); ?>
        :</label>
      <?php foreach ( $intelliwidget->get_eligible_post_types() as $type ) : ?>
      <label style="white-space:nowrap;margin-right:10px" for="<?php echo $this->get_field_id('post_types_' . $type); ?>">
        <input type="checkbox" id="<?php echo $this->get_field_id('post_types_' . $type); ?>" name="<?php echo $this->get_field_name('post_types'); ?>[]" value="<?php echo $type; ?>" <?php checked(in_array($type, $instance['post_types']), 1); ?> />
...
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('itemsettings'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
    <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
    <h4 style="margin:0;padding:8px">
      <?php _e('Item Settings', 'intelliwidget'); ?>
    </h4>
  </div>
  <div id="<?php echo $this->get_field_id('itemsettings'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <p>
...
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('taxonomies'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
    <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
    <h4 style="margin:0;padding:8px">
      <?php _e('Taxonomies', 'intelliwidget'); ?>
    </h4>
  </div>
  <div id="<?php echo $this->get_field_id('taxonomies'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <select class="widefat intelliwidget-multiselect" name="<?php echo $this->get_field_name('category'); ?>[]" size="1" style="font-size:smaller;height:100px;" multiple="multiple" id="<?php echo $this->get_field_id('category'); ?>">
      <?php echo $intelliwidget->get_relevant_terms($instance); ?>
    </select>
  </div>
</div>
<div class="postbox">
  <div class="iw-collapsible" id="<?php echo $this->get_field_id('specificposts'); ?>-panel" title="<?php _e('Click to toggle', 'intelliwidget'); ?>">
    <div class="handlediv" title="<?php _e('Click to toggle', 'intelliwidget'); ?>"></div>
    <h4 style="margin:0;padding:8px">
      <?php _e('Specific Posts', 'intelliwidget'); ?>
    </h4>
  </div>
  <div id="<?php echo $this->get_field_id('specificposts'); ?>-panel-inside" style="display:none;padding:8px" class="closed">
    <select  class="widefat intelliwidget-multiselect" name="<?php echo $this->get_field_name('page'); ?>[]" style="font-size:smaller;height:100px;" multiple="multiple" id="<?php echo $this->get_field_id('page'); ?>">
