...
<a title="<?php echo $intelliwidget_admin->get_tip('iw_add'); ?>" style="float:left;" href="<?php echo $intelliwidget_admin->get_nonce_url($id, 'add'); ?>" id="iw_add_<?php $id; ?>" class="iw-add">
...
<?php
    ...
    function metabox($id, $box_id, $instance) {
        ...
        ?>
        <p>
  <input type="hidden" id="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_category'; ?>" name="<?php echo 'intelliwidget_' . $box_id . '_category'; ?>" value="-1" /><?php /* Original Categories: <?php echo implode(',', $intelliwidget_admin->val2array($instance['category'])); */ ?>
        </p>
<p>
  ...
  <label title="<?php echo $intelliwidget_admin->get_tip('replace_widget'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_replace_widget'; ?>">
...
?>
<span class="submitbox" style="float:left;"><a href="<?php echo $intelliwidget_admin->get_nonce_url($id, 'delete', $box_id); ?>" id="iw_delete_<?php echo $id . '_' . $box_id; ?>" class="iw-delete submitdelete">
...
<div id="iw_generalsettings_<?php echo $id . '_' . $box_id; ?>" class="postbox closed iw-collapsible panel-general">
  ...
  <div  id="iw_generalsettings_<?php echo $id . '_' . $box_id; ?>_inside" class="inside">
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('content'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_content'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('title'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_title'; ?>"> <?php echo $intelliwidget_admin->get_label('title'); ?> </label>
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_label('container_id'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_container_id'; ?>" style="display:block">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('classes'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_classes'; ?>" style="display:block">
...
<?php echo apply_filters('intelliwidget_nocopy_setting', '
    <p>
      <label title="' . $intelliwidget_admin->get_tip('nocopy') . '">
        <input name="intelliwidget_' . $box_id . '_nocopy" id="intelliwidget_' . $id . '_' . $box_id . '_nocopy" type="checkbox" ' . checked($instance['nocopy'], 1) . ' value="1"/> ' . $intelliwidget_admin->get_label('nocopy') . '
      </label>
    </p>
'); ?>
  </div>
...
<div id="iw_addltext_<?php echo $id . '_' . $box_id; ?>" class="postbox closed iw-collapsible panel-addltext">
  ...
  <div  id="iw_addltext_<?php echo $id . '_' . $box_id; ?>_inside" class="inside">
    <label title="<?php echo $intelliwidget_admin->get_tip('text_position'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_text_position'; ?>">
...
<?php echo esc_textarea($instance['custom_text']); ?></textarea>
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('filter'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_filter'; ?>">
...
<div id="iw_appearance_<?php echo $id . '_' . $box_id; ?>" class="postbox closed iw-collapsible panel-appearance">
  ...
  <div id="iw_appearance_<?php echo $id . '_' . $box_id; ?>_inside" class="inside">
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('template'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_template'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('sortby'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_sortby'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('items'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_items'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('length'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_length'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('allowed_tags'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_allowed_tags'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('link_text'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_link_text'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('imagealign'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_imagealign'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('image_size'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_image_size'; ?>">
...
<div id="iw_selection_<?php echo $id . '_' . $box_id; ?>" class="postbox closed iw-collapsible panel-selection">
  ...
  <div id="iw_selection_<?php echo $id . '_' . $box_id; ?>_inside" class="inside">
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('post_types'); ?>" style="display:block;margin-bottom:10px"><span class="spinner <?php echo 'intelliwidget_' . $id . '_' . $box_id . '_spinner'; ?>"></span>
...
?>
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('skip_post'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_skip_post'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('future_only'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_future_only'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('active_only'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_active_only'; ?>">
    ...
    <p>
      <label title="<?php echo $intelliwidget_admin->get_tip('skip_expired'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_skip_expired'; ?>">
...
<?php
    ...
    function nav_menu($id, $box_id, $instance){
        ...
        ?>
<p>
  <label title="<?php echo $intelliwidget_admin->get_tip('nav_menu'); ?>" for="<?php echo 'intelliwidget_' . $id . '_' . $box_id . '_nav_menu'; ?>">
