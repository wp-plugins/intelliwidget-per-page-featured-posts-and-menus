...
class IntelliWidgetMetaBox {
    ...
    function page_form($id, $optiontype) {
        
        global $intelliwidget, $intelliwidget_admin;
        $copy_id = $intelliwidget->get_meta($id, '_intelliwidget_widget_page_id', $optiontype);
...
<p>
  ...
  <select style="width:75%" name="<?php echo 'intelliwidget_widget_page_id'; ?>" id="<?php echo 'intelliwidget_widget_page_id'; ?>">
    ...
    <?php echo $intelliwidget_admin->get_posts_list(array('post_types' => array($post->post_type), 'page' => array($widget_page_id))); ?>
  </select>
</p>
