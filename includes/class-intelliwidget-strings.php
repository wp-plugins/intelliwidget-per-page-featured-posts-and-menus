    ...
    static function get_label( $key = '' ) {
        ...
        switch ( $key ):    
            ...
            case 'title': 
                ...
                break;
            case 'link_title': 
                $value = __( 'Link', 'intelliwidget' ); 
                break;
            case 'hide_title': 
                $value = __( 'Hide', 'intelliwidget' ); 
                break;
            case 'container_id': 
                $value = __( 'Unique ID', 'intelliwidget' ); 
                break;
            case 'classes': 
            ...
            case 'post_types': 
                ...
                break;
            case 'terms': 
                $value = __( 'Select posts identified by', 'intelliwidget' ); 
                break;
            case 'page': 
                $value = __( 'Select specific posts', 'intelliwidget' ); 
                break;
            case 'skip_post': 
