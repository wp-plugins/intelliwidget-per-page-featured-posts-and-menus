...
/*
    ...
    Description: Display featured posts, custom menus, html content and more within a single dynamic sidebar that can be customized on a per-page basis or globally.
    Version: 1.0.1
    Author: Lilaea Media
    ...
    * *************************************************************************
    ...
    Portions based on Featured Page Widget 
